...
public final class CCClientboundPackets {
    ...
    public static void onRegisterPayloadHandler(RegisterPayloadHandlersEvent e) {
        ...
        registrar.playToClient(TrainHUDTopSpeedPayload.TYPE, TrainHUDTopSpeedPayload.STREAM_CODEC,
                (payload, ctx) -> updateTrainHUDTopSpeed(payload));
    }

    private static void updateTrainHUDTopSpeed(TrainHUDTopSpeedPayload payload) {
